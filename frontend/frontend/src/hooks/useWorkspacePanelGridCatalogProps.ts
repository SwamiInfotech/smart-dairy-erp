...
export function useWorkspacePanelGridCatalogProps({
  ...
  return {
    ...
    editingProductUuid: ops.commercialCrud.editingProductUuid,
    onCreateProduct: ops.commercialCrud.onCreateProduct,
    onEditProduct: ops.commercialCrud.onEditProduct,
    onCancelProductEdit: ops.commercialCrud.onCancelProductEdit,
    onDeleteProduct: ops.commercialCrud.onDeleteProduct,
